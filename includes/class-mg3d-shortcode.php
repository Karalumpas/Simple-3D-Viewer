...
class MG3D_Shortcode {
    ...
    public function render_shortcode($atts) {
        ...
        $output .= '<button class="save-camera-position" title="' . esc_attr__('Save Current View', 'mg-3d-productviewer') . '">';
        $output .= '<svg viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>';
        $output .= __('Save View', 'mg-3d-productviewer');
        $output .= '</button>';
        
        $output .= '<button class="reset-camera" title="' . esc_attr__('Reset to Default View', 'mg-3d-productviewer') . '">';
        ...
        $output .= __('Reset View', 'mg-3d-productviewer');
        $output .= '</button>';
